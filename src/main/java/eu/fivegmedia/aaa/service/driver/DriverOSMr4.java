...
public class DriverOSMr4 implements IDriverUser, IDriverDatacenter{
	...
	public String authenticateAndGetToken(ResourceUser resourceUserDB) {
		...
		//authenticate
		String username = resource.getResourceAdminLogin().getUsername();
		String password = resource.getResourceAdminLogin().getPassword();
