...
import { ResourceAdminLoginService } from '../resource-admin-login';
...
export class ResourceComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.resourceAdminLoginData = '???';
    }

    loadResourceAdminLoginByID(id: number) {
        this.resourceAdminLoginService
            .find(id)
            .subscribe((res: HttpResponse<IResourceAdminLogin>) => (this.resourceAdminLoginData = res.body.username));
    }
