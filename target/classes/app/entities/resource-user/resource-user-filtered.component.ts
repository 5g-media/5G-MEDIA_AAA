...
import { ResourceUserLoginService } from 'app/entities/resource-user-login/resource-user-login.service';
...
import { ResourceUserService } from 'app/entities/resource-user/resource-user.service';

@Component({
    selector: 'jhi-resource-user',
    templateUrl: './resource-user-filtered.component.html'
})
export class ResourceUserFilteredComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.resourceUserService
            .queryByCatalogUser(this.catalogUser.id)
            .subscribe(
